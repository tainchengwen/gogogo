                    ...
                    <div class="box">
                        <div class="box-header" style="height:70px;width:100%;">
                            ...
                            <div style="float: left;width:50%;text-align: left;line-height: 30px">
                                <a class="btn btn-sm btn-success"  style="font-size:25px;margin-top:5px;" href="{{ url('addCheckGoods') }}" ><i class="fa fa-crosshairs"></i>添加新盘点</a>
                            </div>
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach($check_goods as $key => $vo)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $vo -> count_goods }}</td>

                                        <td>{{ date('Y-m-d H:i:s',$vo -> created_at) }}</td>
                                        <td>
                                            <a class="btn btn-sm btn-primary " data="{{ $vo -> id }}"  href="{{ url('addCheckGoodsDetail').'?id='.$vo -> id }}"   >编辑</a>
                                        </td>
                                    </tr>
