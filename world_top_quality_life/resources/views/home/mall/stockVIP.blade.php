					...
					//console.log(data);
                        ...
                        if(data.length){
                            ...
                            for(var i=0;i<data.length;i++){
                                ...
                                content+='<div class="commodity_kucun" style="color:red;">'+' 价格: &nbsp;&nbsp; ￥'+data[i].price+'</div>';
                                content+='<div class="commodity_kucun">'+data[i].mp_name+'</div>';
                                content+='<div class="commodity_num">';
...
<body>
<input type="hidden" id="Load_Url" value="{{ url('mall/ajaxGetStockVIPInfo/'.$level ) }}">
