<div class="col-md-12" style="padding-left:9px;">
    <div class="box">
        <div class="box-header">
            <form method="get" action="{{ admin_url('scanMakeAreaScanOrder') }}" id="myForm">
            ...
            <div class="pull-left" style="padding-left:10px;">
                ...
                <br>
                    <a class="btn btn-sm btn-facebook" style="margin-top:10px;" href="{{ admin_url('scanMakeAreaScanOrder') }}" ><i class="fa fa-backward"></i>  重置</a>
                <br>
                <a class="btn btn-sm btn-facebook" style="margin-top:10px;" id="makeAreaOrder" >生成交货单</a>
            </div>
        ...
        <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <!--
                    <td>
                        <a class="btn btn-sm btn-danger" href="{{ admin_url('scanMakeAreaScanOrder?'.'del_id='.$vo -> id.'&hide_input='.$_GET['hide_input']) }}" >DEL</a>
                    </td>
                    -->
                </tr>
                    @endforeach
