    ...
    <div class="row">
        ...
        @endif
            ...
            <table class="table" id="myTable">
                ...
                <input type="hidden" name="user_id" value="{{ $compact['user_id'] }}" />
...
@endif
                            ...
                            <input type="hidden" name="address[]" value="{{ $vo -> country.$vo -> address }}" />
...
//分配的人
        ...
        if(confirm('确定删除么？')){
            var url = '{{ admin_base_path('deleteUserAddress') }}';
