<div class="col-md-12" style="padding-left:9px;">
    <div class="box">
        <div class="box-header">
            <form method="get" action="{{ admin_url('scanMpPackage') }}" id="myForm">
            ...
            <div class="pull-left" style="padding-left:10px;">
                ...
                <br>
                    <a class="btn btn-sm btn-facebook" style="margin-top:10px;" href="{{ admin_url('scanMpPackage') }}" ><i class="fa fa-backward"></i>  重置</a>
...
<script>
    ...
    @if($packages)
            location.href='{{ admin_url('scanMpPackageGoods').'?id='.$packages -> id }}';
    @endif
